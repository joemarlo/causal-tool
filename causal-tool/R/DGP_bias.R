...
means_bias_DGP <- function(means_bias_select_n, means_bias_slider_smoker, means_bias_slider_error, means_bias_slider_tau_smoker, means_bias_slider_tau_nonsmoker, means_bias_slider_conditional){
  ...
  y_1 <- 10 + (means_bias_slider_tau_nonsmoker * (1 - smoker)) + (means_bias_slider_tau_smoker * smoker) + rnorm(N, 0, means_bias_slider_error)
