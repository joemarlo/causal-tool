UI_randomization <- tabPanel(title = "Randomization",
         sidebarLayout(
           sidebarPanel(
             ...
             "Now select which datapoints to include in the treatment group by clicking on points in the plot. How do the univariate densities compare between treatment and control?",
             br(), br(),
